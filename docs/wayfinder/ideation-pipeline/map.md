...
- [Choose and calibrate local literature ranking](tickets/021-choose-and-calibrate-local-ranking.md): v1 在 3–36 篇 approved corpus 内采用冻结 BM25（`k1=1.6,b=0.5,title_weight=1,max aggregation,phrase_bonus=false,paper_cap=3`）；E5 未跨 qrels/operational evidence 完成 promotion burden，因此只保留为 diagnostic challenger，不作为 fallback 或科学败者。
