    ...
    internal_modules=frozenset(
        {
            ...
            "ai_scientist.ideation.comparison",
            "ai_scientist.ideation.comparison_ai",
            "ai_scientist.ideation.comparison_preauthorization",
            "ai_scientist.ideation.contract",
            "ai_scientist.ideation.controller",
            "ai_scientist.ideation.deepseek",
            "ai_scientist.ideation.errors",
            "ai_scientist.ideation.evaluation",
            "ai_scientist.ideation.evaluation_costs",
            "ai_scientist.ideation.evaluation_protocol",
            "ai_scientist.ideation.evidence",
            "ai_scientist.ideation.migration",
